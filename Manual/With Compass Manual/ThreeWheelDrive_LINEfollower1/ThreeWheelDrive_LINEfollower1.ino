...
void loop(){
      Serial.println("LeftAnalogTheta"+String(LeftAnalogTheta)+"pwm"+String(PWMfactor));
      getPS2value();    
      scalePS2value();
      PS2executePressed();      
      GetCompassHeading(1);
      ...
      LeftAnalogTheta=((int)(LeftAnalogTheta+180)%360); 
       ...
       {  PWMfactor=3; //forward0backward
          //rpm=rpmmax;
       }
      //else if((LeftAnalogTheta < 45.0 && LeftAnalogTheta >310.0) || (LeftAnalogTheta < 200.0 && LeftAnalogTheta >160.0)) 
